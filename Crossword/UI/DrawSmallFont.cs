...
public sealed partial class CrosswordApp
{
    ...
    // private void DrawSmallFontNew(ClueAnswer clueAnswer, Square puzzleSquare, Rectangle rectSquare, DynamicSpriteFont numFont, SpriteBatch spriteBatch)
    // {
    //   
