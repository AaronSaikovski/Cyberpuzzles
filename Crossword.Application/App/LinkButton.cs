...
/// <summary>
    ...
    /// Draws content.
    /// </summary>
    public class LinkButton : Clickable
    {
        ...
        public LinkButton (CrosswordApp game, string textureName, Rectangle targetRectangle, int initialValue)
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Game._spriteBatch.Draw(texture, Rectangle, color);
